---
title: Actionable Relationship Center
...
With a few simple configurations a lot of functionality can be added to Agent's benefit.

- Add Premises and Serve Point to Service Account Record Types
- Add statement data to Billing Account Record Types
- Add Payment Method data to Billing Account Record Types
